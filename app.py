...
def process_documentation():
    ...
    # Por ahora, guardamos el texto limpio en un campo de Firestore.
    # Más adelante, aquí iniciaremos el chunking y la creación de embeddings.
    # una base de datos vectorial. Por ahora, solo guardaremos una referencia.
